        ...
        <table class="table table-hover table-striped">
            ...
            <?php foreach ($_SESSION['cart'] as $id=>$item): ?>
                <tr>
                    ...
                    <td class="fit text-center" ><input id="qty" onkeydown="javascript: return event.keyCode === 8 ||
event.keyCode === 46 ? true : !isNaN(Number(event.key))" data-id="<?= $id; ?>" type="number" class="fit text-center" min="1" value="<?= $item['qty']; ?>"></span></td>
